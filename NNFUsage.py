...
#[nndbs_tr, _, _, _, _, _] = DbSlice.slice(nndb, sel)
#nndbs_tr[0].show()
#nndbs_tr[1].show()
#nndbs_tr[2].show()
#nndbs_tr[3].show()
...
#[nndb_tr, nndb_val, nndb_te, nndb_tr_out, nndb_val_out, _] = DbSlice.slice(nndb, sel)
#nndb_tr.show(10, 3)
#nndb_val.show(10, 2)
#nndb_te.show(4, 2)
...
#    def generate_nnmodels(self, dict_iterstore, list_iterstore):
#        """overiddable"""
#        # Can use interal patch information to generate patch specific models

#        # Model I for 'self' patch
#        nnmodels = []
#        nnmodels.append(DAEModel(self, dict_iterstore, list_iterstore))        
...
#sel = Selection()
#sel.use_rgb = False
#sel.tr_col_indices = np.array([1, 1])
##sel.tr_col_indices = Select.ALL
#sel.tr_out_col_indices = None # np.array([])
#sel.val_col_indices = np.array([1, 1, 4])
#sel.val_out_col_indices = np.array([])
#sel.te_col_indices = None # np.array([])
...
##param = {'alias': "DB1",
#        'nndb': nndb, 'db_dir': None, 
#        'selection': sel, 'db_pp_param': None, 'iter_pp_param': None,
#        'iter_in_mem': True}
#nnpatchman = NNPatchMan(AEPG(nndb.h, nndb.w, 33, 33, 33, 33), param)

## Use nndb, write the processed data on to the disk, iterators read from the disk
#param = {'alias': "DB1",
#        'nndb': nndb, 'db_dir': "D:/TestImageFolder", 
#        'selection': sel, 'db_pp_param': None, 'iter_pp_param': None,
#        'iter_in_mem': False}
#nnpatchman = NNPatchMan(AEPG(nndb.h, nndb.w, 33, 33, 33, 33), [param])
...
#param = {'alias': "DB1",
#        'nndb': None, 'db_dir': "D:/TestImageFolder", 
#        'selection': sel, 'db_pp_param': None, 'iter_pp_param': None,
#        'iter_in_mem': False}
#nnpatchman = NNPatchMan(AEPG(nndb.h, nndb.w, 33, 33, 33, 33), [param])

# Use no database, explicit database will be specified via NNCfg during the pre-training of the model
#param = {'alias': "DB1",
#        'nndb': None, 'db_dir': None, 
#        'selection': None, 'db_pp_param': None, 'iter_pp_param': None,
#        'iter_in_mem': True}
#nnpatchman = NNPatchMan(AEPG(nndb.h, nndb.w, 33, 33, 33, 33), [param])
...
#        """
#        nnmodels = []
#        nnmodels.append(DAEModel(None, None, None))  
#        return nnmodels
...
#        'selection': sel, 'db_pp_param': None, 'iter_pp_param': None,
#        'iter_in_mem': True}
#nnmodelman = NNModelMan(AEMG(), param)
